...
do ->
  ...
  grammar = {
    ...
    ParserRules: [
          ...
          {"name": "unary$subexpression$1", "symbols": ["unary_+operator+", "expr"]},
          {"name": "unary", "symbols": ["unary$subexpression$1"], "postprocess": $unpack    'unary',         0},
          {"name": "binary$subexpression$1", "symbols": ["binary_+operator+", "expr", "expr"]},
          {"name": "binary", "symbols": ["binary$subexpression$1"], "postprocess": $unpack    'binary',        0},
          {"name": "+bracket+ed$subexpression$1", "symbols": ["lbracket", "binary_+operator+", "expr3+", "rbracket"]},
          ...
          {"name": "unary_+operator+$subexpression$1", "symbols": ["similar"]},
          {"name": "unary_+operator+$subexpression$1", "symbols": ["heavy"]},
          {"name": "unary_+operator+$subexpression$1", "symbols": ["light"]},
          {"name": "unary_+operator+$subexpression$1", "symbols": ["doubt"]},
          {"name": "unary_+operator+$subexpression$1", "symbols": ["upsidedown"]},
          {"name": "unary_+operator+$subexpression$1", "symbols": ["mirror"]},
          {"name": "unary_+operator+$subexpression$1", "symbols": ["flip"]},
          {"name": "unary_+operator+", "symbols": ["unary_+operator+$subexpression$1"], "postprocess": $unpack 'unary_+operator+',  0, 0},
          {"name": "binary_+operator+$subexpression$1", "symbols": ["leftright"]},
          {"name": "binary_+operator+$subexpression$1", "symbols": ["topdown"]},
          {"name": "binary_+operator+$subexpression$1", "symbols": ["surround"]},
          {"name": "binary_+operator+$subexpression$1", "symbols": ["cap"]},
          {"name": "binary_+operator+$subexpression$1", "symbols": ["cup"]},
          {"name": "binary_+operator+$subexpression$1", "symbols": ["leftembrace"]},
          {"name": "binary_+operator+$subexpression$1", "symbols": ["topleft"]},
          {"name": "binary_+operator+$subexpression$1", "symbols": ["topright"]},
          {"name": "binary_+operator+$subexpression$1", "symbols": ["leftbottom"]},
          {"name": "binary_+operator+$subexpression$1", "symbols": ["interlace"]},
          {"name": "binary_+operator+$subexpression$1", "symbols": ["topleftcorner"]},
          {"name": "binary_+operator+", "symbols": ["binary_+operator+$subexpression$1"], "postprocess": $unpack 'binary_+operator+',  0, 0},
