      ...
      ParserRules: [
        {
          ...
          "symbols": ["binary_operator", "expr", "expr"]
        }, {
          "name": "binary",
          "symbols": ["binary$subexpression$1"],
          "postprocess": $unpack('binary', 0)
        }, {
          "name": "bracketed$subexpression$1",
          "symbols": ["lbracket", "binary_operator", "expr3+", "rbracket"]
        }, {
          "name": "bracketed",
          "symbols": ["bracketed$subexpression$1"],
          "postprocess": $unbracket('bracketed', 0)
        }, {
          "name": "component",
          "symbols": ["proxy"]
        }, {
          ...
          "postprocess": $unpack('unary_operator', 0, 0)
        }, {
          ...
          "name": "bracket",
          "symbols": ["bracket$subexpression$1"],
          "postprocess": $unpack('bracket')
        }, {
