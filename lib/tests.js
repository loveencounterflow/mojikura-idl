...
(function() {
  ...
  this["(IDL) reject bogus formulas"] = function(T) {
    ...
    probes_and_matchers = [["木", "syntax error: lone token of type 'component' [  ✘ 木 ✘  ]"], [42, "expected a text, got a number"], ["", "syntax error: empty text"], ["⿱⿰亻式⿱目八木木木", "syntax error: extra token(s) [ ⿱⿰亻式⿱目八 ✘ 木 ✘ 木木 ]"], ["⿺廴聿123", "syntax error: extra token(s) [ ⿺廴聿 ✘ 1 ✘ 23 ]"], ["⿺", "syntax error: premature end of source [  ✘ ⿺ ✘  ]"], ["⿺⿺⿺⿺", "syntax error: premature end of source [ ⿺⿺⿺ ✘ ⿺ ✘  ]"], ["⿺12", "syntax error: illegal token '1' (type 'other') [ ⿺ ✘ 1 ✘ 2 ]"], ["(⿰亻聿式)", "syntax error: illegal token '(' (type 'other') [  ✘ ( ✘ ⿰亻聿式) ]"], ["≈〇", "syntax error: illegal token '≈' (type 'other') [  ✘ ≈ ✘ 〇 ]"], ["●", "syntax error: illegal token '●' (type 'other') [  ✘ ● ✘  ]"]];
    for (i = 0, len = probes_and_matchers.length; i < len; i++) {
      ref1 = probes_and_matchers[i], probe = ref1[0], matcher = ref1[1];
      try {
  ...
  this["(IDLX) reject bogus formulas"] = function(T) {
    var error, error1, i, len, matcher, message, probe, probes_and_matchers, ref1, result;
    probes_and_matchers = [["木", "syntax error: lone token of type 'component' [  ✘ 木 ✘  ]"], [42, "expected a text, got a number"], ["", "syntax error: empty text"], ["⿱⿰亻式⿱目八木木木", "syntax error: extra token(s) [ ⿱⿰亻式⿱目八 ✘ 木 ✘ 木木 ]"], ["⿺廴聿123", "syntax error: extra token(s) [ ⿺廴聿 ✘ 1 ✘ 23 ]"], ["⿺", "syntax error: premature end of source [  ✘ ⿺ ✘  ]"], ["⿺⿺⿺⿺", "syntax error: premature end of source [ ⿺⿺⿺ ✘ ⿺ ✘  ]"], ["⿺12", "syntax error: illegal token '1' (type 'other') [ ⿺ ✘ 1 ✘ 2 ]"]];
    for (i = 0, len = probes_and_matchers.length; i < len; i++) {
      ref1 = probes_and_matchers[i], probe = ref1[0], matcher = ref1[1];
      try {
  ...
  this["(IDLX) reject IDL operators with arity 3"] = function(T) {
    var error, error1, i, len, matcher, message, probe, probes_and_matchers, ref1, result;
    probes_and_matchers = [["⿲木木木", "syntax error: extra token(s) [ ⿲ ✘ 木 ✘ 木木 ]"]];
    for (i = 0, len = probes_and_matchers.length; i < len; i++) {
      ref1 = probes_and_matchers[i], probe = ref1[0], matcher = ref1[1];
      try {
        result = IDLX.parse(probe);
  ...
  this["(IDLX) reject bogus formulas (bracketed)"] = function(T) {
    var error, error1, i, len, matcher, message, probe, probes_and_matchers, ref1, result;
    probes_and_matchers = [["()", "syntax error: unexpected right bracket [ ( ✘ ) ✘  ]"], ["(⿰)", "syntax error: too few constituents [ (⿰ ✘ ) ✘  ]"], ["(聿)", "syntax error: extra token(s) [ (聿 ✘ ) ✘  ]"], [")", "syntax error: unexpected right bracket [  ✘ ) ✘  ]"], ["⿰)", "syntax error: unexpected right bracket [ ⿰ ✘ ) ✘  ]"], ["聿)", "syntax error: extra token(s) [ 聿 ✘ ) ✘  ]"], ["(⿰亻聿)", "syntax error: too few constituents [ (⿰亻聿 ✘ ) ✘  ]"], ["(⿰亻)", "syntax error: too few constituents [ (⿰亻 ✘ ) ✘  ]"], ["(⿰亻)聿", "syntax error: too few constituents [ (⿰亻 ✘ ) ✘ 聿 ]"], ["(≈北㓁)", "syntax error: cannot bracket unary operator [ ( ✘ ≈ ✘ 北㓁) ]"]];
    for (i = 0, len = probes_and_matchers.length; i < len; i++) {
      ref1 = probes_and_matchers[i], probe = ref1[0], matcher = ref1[1];
      try {
        result = IDLX.parse(probe);
  ...
  this["(IDLX) reject bogus formulas (solitaires)"] = function(T) {
    var error, error1, i, len, matcher, message, probe, probes_and_matchers, ref1, result;
    probes_and_matchers = [["⿱〓▽", "syntax error: cannot have a solitaire here [ ⿱〓 ✘ ▽ ✘  ]"], ["↻●", "syntax error: cannot have a solitaire here [ ↻ ✘ ● ✘  ]"], ["↔≈▽", "syntax error: cannot have a solitaire here [ ↔≈ ✘ ▽ ✘  ]"], ["●亻", "syntax error: extra token(s) [ ● ✘ 亻 ✘  ]"], ["(●亻式)", "syntax error: cannot have a solitaire here [ ( ✘ ● ✘ 亻式) ]"], ["(⿰亻●式)", "syntax error: cannot have a solitaire here [ (⿰亻 ✘ ● ✘ 式) ]"], ["(⿱▽㓁允)", "syntax error: cannot have a solitaire here [ (⿱ ✘ ▽ ✘ 㓁允) ]"], ["⿹弓(⿰(⿱人人丨)(⿱人人丨)(⿱人●丨))", "syntax error: cannot have a solitaire here [ ⿹弓(⿰(⿱人人丨)(⿱人人丨)(⿱人 ✘ ● ✘ 丨)) ]"]];
    for (i = 0, len = probes_and_matchers.length; i < len; i++) {
      ref1 = probes_and_matchers[i], probe = ref1[0], matcher = ref1[1];
      try {
        result = IDLX.parse(probe);
  ...
  if (module.parent == null) {
    include = ["sanity checks (private methods)", "sanity checks (grammar data)", "sanity checks (MKNCR)", "(IDL) parse simple formulas", "(IDL) reject bogus formulas", "(IDL) parse tree of simple formulas", "(IDLX) reject bogus formulas", "(IDLX) reject IDL operators with arity 3", "(IDLX) parse simple formulas", "(IDLX) parse extended formulas (plain)", "(IDLX) parse extended formulas (bracketed)", "(IDLX) reject bogus formulas (bracketed)", "(IDLX) reject bogus formulas (solitaires)"];
    this._prune();
    this._main();
  }
