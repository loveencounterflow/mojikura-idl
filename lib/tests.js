...
(function() {
  ...
  this["(IDLX) reject bogus formulas"] = function(T) {
    var error, i, len, matcher, message, probe, probes_and_matchers, ref1, result;
    probes_and_matchers = [["木", "IDL: lone token of type 'component' [  ✘ 木 ✘  ]"], [42, "expected a text, got a number"], ["〓", "IDL: lone token of type 'proxy' [  ✘ 〓 ✘  ]"], ["", "IDL: empty text"], ["⿱⿰亻式⿱目八木木木", "IDL: extra token(s) [ ⿱⿰亻式⿱目八 ✘ 木 ✘ 木木 ]"], ["⿺廴聿123", "IDL: extra token(s) [ ⿺廴聿 ✘ 1 ✘ 23 ]"], ["⿺", "IDLX: premature end of source [  ✘ ⿺ ✘  ]"], ["⿺⿺⿺⿺", "IDLX: premature end of source [ ⿺⿺⿺ ✘ ⿺ ✘  ]"]];
    for (i = 0, len = probes_and_matchers.length; i < len; i++) {
      ref1 = probes_and_matchers[i], probe = ref1[0], matcher = ref1[1];
      try {
  ...
  this["(IDLX) reject bogus formulas (solitaires)"] = function(T) {
    var error, i, len, matcher, message, probe, probes_and_matchers, ref1, result;
    probes_and_matchers = [["〓", "IDL: lone token of type 'proxy' [  ✘ 〓 ✘  ]"], ["§", "IDL: lone token of type 'proxy' [  ✘ § ✘  ]"], ["⿱式●", "IDLX: cannot have a solitaire here [ ⿱式 ✘ ● ✘  ]"], ["⿱式▽", "IDLX: cannot have a solitaire here [ ⿱式 ✘ ▽ ✘  ]"], ["⿱式∅", "IDLX: cannot have a solitaire here [ ⿱式 ✘ ∅ ✘  ]"], ["⿱〓▽", "IDLX: cannot have a solitaire here [ ⿱〓 ✘ ▽ ✘  ]"], ["↻●", "IDLX: cannot have a solitaire here [ ↻ ✘ ● ✘  ]"], ["↔≈▽", "IDLX: cannot have a solitaire here [ ↔≈ ✘ ▽ ✘  ]"], ["●亻", "IDLX: cannot have a solitaire here [  ✘ ● ✘ 亻 ]"], ["(●亻式)", "IDLX: cannot have a solitaire here [ ( ✘ ● ✘ 亻式) ]"], ["(⿰亻●式)", "IDLX: cannot have a solitaire here [ (⿰亻 ✘ ● ✘ 式) ]"], ["(⿱▽㓁允)", "IDLX: cannot have a solitaire here [ (⿱ ✘ ▽ ✘ 㓁允) ]"], ["⿹弓(⿰(⿱人人丨)(⿱人人丨)(⿱人●丨))", "IDLX: cannot have a solitaire here [ ⿹弓(⿰(⿱人人丨)(⿱人人丨)(⿱人 ✘ ● ✘ 丨)) ]"]];
    for (i = 0, len = probes_and_matchers.length; i < len; i++) {
      ref1 = probes_and_matchers[i], probe = ref1[0], matcher = ref1[1];
      try {
        result = IDLX.diagram_from_source(probe);
  ...
  this["(IDLX) tree-shaking"] = function(T) {
    var diagram, formula_uchr, glyph, glyphs_probes_and_matchers, i, len, matcher, new_ctx, old_ctx, probe, probe_maybe_suboptimal, probe_was_suboptimal, ref1, sexpr_uchr;
    ...
    for (i = 0, len = glyphs_probes_and_matchers.length; i < len; i++) {
      ...
      formula_uchr = new_ctx.formula_uchr, sexpr_uchr = new_ctx.sexpr_uchr, diagram = new_ctx.diagram;
  ...
  if (module.parent == null) {
    include = ["(IDL) demo", "sanity checks (grammar data)", "(IDL) parse simple formulas", "(IDL) reject bogus formulas", "(IDL) parse tree of simple formulas", "(IDLX) reject bogus formulas", "(IDLX) reject IDL operators with arity 3", "(IDLX) parse simple formulas", "(IDLX) parse extended formulas (plain)", "(IDLX) parse extended formulas (bracketed)", "(IDLX) reject bogus formulas (bracketed)", "(IDLX) reject bogus formulas (solitaires)", "(IDL) _tokentree_as_formula", "(IDLX) _tokentree_as_formula", "(IDLX) formula_from_source (1)", "(IDLX) formula_from_source (2)", "(IDLX) sexpr_from_source", "(IDLX) doubt mark", "(IDLX) tree-shaking"];
    this._prune();
    this._main();
