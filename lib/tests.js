...
(function() {
  var CND, IDL, IDLX, MKNCR, alert, badge, debug, demo_glyph_conversion, demo_new_api, echo, help, include, info, log, nice_text_rpr, ref, resume_next, rpr, test, urge, warn, whisper,
  ...
  this["(IDL) _tokentree_as_text"] = function(T) {
  ...
  this["(IDLX) _tokentree_as_text"] = function(T) {
    ...
    * other normalizations (e.g. order of operators / terms)?
     */
    var ctx, i, len, matcher, probe, probes_and_matchers, ref1, result;
    probes_and_matchers = [["⿺辶言", "⿺辶言"], ["⿺辶〓", "⿺辶〓"], ["●", "●"], ["〓", "〓"], ["⿱癶⿰弓貝", "⿱癶⿰弓貝"], ["⿱⿰亻式貝", "⿱⿰亻式貝"], ["⿱⿰亻式⿱目八", "⿱⿰亻式⿱目八"], ["▽", "▽"], ["≈〇", "≈〇"], ["⿱〓〓", "⿱〓〓"], ["↻正", "↻正"], ["↔≈匕", "↔≈匕"], ["↔正", "↔正"], ["⿱丶乂", "⿱丶乂"], ["⿺走⿹◰口戈日", "⿺走⿹◰口戈日"], ["≈匚", "≈匚"], ["(⿱北㓁允)", "(⿱北㓁允)"], ["⿹弓(⿰(⿱人人丨)(⿱人人丨)(⿱人人丨))", "⿹弓(⿰(⿱人人丨)(⿱人人丨)(⿱人人丨))"], ["⿹弓(⿰(⿱人人丨)(⿱人人丨)(⿱人人丨))", "⿹弓(⿰(⿱人人丨)(⿱人人丨)(⿱人人丨))"], ["⿰臣(⿱𠂉(⿰人人人)(⿰古古古))", "⿰臣(⿱𠂉(⿰人人人)(⿰古古古))"]];
    for (i = 0, len = probes_and_matchers.length; i < len; i++) {
      ref1 = probes_and_matchers[i], probe = ref1[0], matcher = ref1[1];
  ...
  this["(experimental) using arbitrary characters as components"] = function(T) {
    var i, len, matcher, probe, probes_and_matchers, ref1, result, tokentree;
    probes_and_matchers = [["⿱´a", ""], ["⿺Lx", ""]];
    for (i = 0, len = probes_and_matchers.length; i < len; i++) {
      ref1 = probes_and_matchers[i], probe = ref1[0], matcher = ref1[1];
  ...
  if (module.parent == null) {
    include = ["sanity checks (private methods)", "sanity checks (grammar data)", "sanity checks (MKNCR)", "(IDL) parse simple formulas", "(IDL) reject bogus formulas", "(IDL) parse tree of simple formulas", "(IDLX) reject bogus formulas", "(IDLX) reject IDL operators with arity 3", "(IDLX) parse simple formulas", "(IDLX) parse extended formulas (plain)", "(IDLX) parse extended formulas (bracketed)", "(IDLX) reject bogus formulas (bracketed)", "(IDLX) reject bogus formulas (solitaires)", "(IDL) _tokentree_as_text", "(IDLX) _tokentree_as_text"];
    this._prune();
    ...
    demo_glyph_conversion = function() {
      ...
      MKNCR.chr_from_cid_and_csg = function(cid, csg) {
        return this.as_chr(cid, {
          csg: csg
        });
      };
      MKNCR.jzr_as_xncr = function(glyph) {
        ...
        return this.chr_from_cid_and_csg(nfo.cid, 'jzr');
      };
      glyph = "&jzr#xe234;";
      ...
      return debug('32900', MKNCR.jzr_as_xncr('x'));
    };
