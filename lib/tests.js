...
(function() {
  ...
  this["(IDL) sanity checks (private methods)"] = function(T) {
    var i, len, matcher, probe, probes_and_matchers, ref1, result, results;
    ...
    for (i = 0, len = probes_and_matchers.length; i < len; i++) {
      ...
      results.push(T.eq(result, matcher));
    }
    return results;
  };
  ...
  if (module.parent == null) {
    include = ["(IDL) sanity checks (private methods)", "(IDL) parse simple formulas", "(IDL) reject bogus formulas", "(IDLX) parse simple formulas", "(IDLX) reject bogus formulas", "(IDLX) reject IDL operators with arity 3"];
    this._prune();
    this._main();
  }
