...
(function() {
  ...
  this["(IDLX) reject IDL operators with arity 3"] = function(T) {
    var error, error1, i, len, matcher, message, probe, probes_and_matchers, ref1, result;
    probes_and_matchers = [["⿲木木木", "IDL: extra token(s) [ ⿲ ✘ 木 ✘ 木木 ]"]];
    for (i = 0, len = probes_and_matchers.length; i < len; i++) {
      ref1 = probes_and_matchers[i], probe = ref1[0], matcher = ref1[1];
      try {
        result = IDLX.parse(probe);
  ...
  this["(IDLX) reject bogus formulas (solitaires)"] = function(T) {
    var error, error1, i, len, matcher, message, probe, probes_and_matchers, ref1, result;
    probes_and_matchers = [["⿱〓▽", "IDLX: cannot have a solitaire here [ ⿱〓 ✘ ▽ ✘  ]"], ["↻●", "IDLX: cannot have a solitaire here [ ↻ ✘ ● ✘  ]"], ["↔≈▽", "IDLX: cannot have a solitaire here [ ↔≈ ✘ ▽ ✘  ]"], ["●亻", "IDL: extra token(s) [ ● ✘ 亻 ✘  ]"], ["(●亻式)", "IDLX: cannot have a solitaire here [ ( ✘ ● ✘ 亻式) ]"], ["(⿰亻●式)", "IDLX: cannot have a solitaire here [ (⿰亻 ✘ ● ✘ 式) ]"], ["(⿱▽㓁允)", "IDLX: cannot have a solitaire here [ (⿱ ✘ ▽ ✘ 㓁允) ]"], ["⿹弓(⿰(⿱人人丨)(⿱人人丨)(⿱人●丨))", "IDLX: cannot have a solitaire here [ ⿹弓(⿰(⿱人人丨)(⿱人人丨)(⿱人 ✘ ● ✘ 丨)) ]"]];
    for (i = 0, len = probes_and_matchers.length; i < len; i++) {
      ref1 = probes_and_matchers[i], probe = ref1[0], matcher = ref1[1];
      try {
        result = IDLX.parse(probe);
