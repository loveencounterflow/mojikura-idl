...
(function() {
  ...
  this["(IDLX) reject bogus formulas (bracketed)"] = function(T) {
    var error, error1, i, len, matcher, message, probe, probes_and_matchers, ref1, result;
    probes_and_matchers = [["()", "syntax error: unexpected right bracket [ ( ✘ ) ✘  ]"], ["(⿰)", "syntax error: too few constituents in [ (⿰ ✘ ) ✘  ]"], ["(聿)", "syntax error: extra token(s) in [ (聿 ✘ ) ✘  ]"], [")", "syntax error: unexpected right bracket [  ✘ ) ✘  ]"], ["⿰)", "syntax error: unexpected right bracket [ ⿰ ✘ ) ✘  ]"], ["聿)", "syntax error: extra token(s) in [ 聿 ✘ ) ✘  ]"], ["(⿰亻聿)", "syntax error: too few constituents in [ (⿰亻聿 ✘ ) ✘  ]"], ["(⿰亻)", "syntax error: too few constituents in [ (⿰亻 ✘ ) ✘  ]"], ["(⿰亻)聿", "syntax error: too few constituents in [ (⿰亻 ✘ ) ✘ 聿 ]"], ["(≈北㓁)", "syntax error: cannot bracket unary operator [ ( ✘ ≈ ✘ 北㓁) ]"]];
    for (i = 0, len = probes_and_matchers.length; i < len; i++) {
      ref1 = probes_and_matchers[i], probe = ref1[0], matcher = ref1[1];
      try {
        result = IDLX.parse(probe);
  ...
  this["(IDLX) reject bogus formulas (solitaires)"] = function(T) {
    var error, error1, i, len, matcher, message, probe, probes_and_matchers, ref1, result;
    probes_and_matchers = [["⿱〓▽", "syntax error: cannot have a solitaire here [ ⿱〓 ✘ ▽ ✘  ]"], ["↻●", "syntax error: cannot have a solitaire here [ ↻ ✘ ● ✘  ]"], ["↔≈▽", "syntax error: cannot have a solitaire here [ ↔≈ ✘ ▽ ✘  ]"], ["●亻", "syntax error: extra token(s) in [ ● ✘ 亻 ✘  ]"], ["(●亻式)", "syntax error: cannot have a solitaire here [ ( ✘ ● ✘ 亻式) ]"], ["(⿰亻●式)", "syntax error: cannot have a solitaire here [ (⿰亻 ✘ ● ✘ 式) ]"], ["(⿱▽㓁允)", "syntax error: cannot have a solitaire here [ (⿱ ✘ ▽ ✘ 㓁允) ]"], ["⿹弓(⿰(⿱人人丨)(⿱人人丨)(⿱人●丨))", "syntax error: cannot have a solitaire here [ ⿹弓(⿰(⿱人人丨)(⿱人人丨)(⿱人 ✘ ● ✘ 丨)) ]"]];
    for (i = 0, len = probes_and_matchers.length; i < len; i++) {
      ref1 = probes_and_matchers[i], probe = ref1[0], matcher = ref1[1];
      try {
        result = IDLX.parse(probe);
