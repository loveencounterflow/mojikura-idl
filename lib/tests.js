...
(function() {
  var CND, IDL, IDLX, alert, badge, debug, echo, help, include, info, join, log, nice_text_rpr, njs_path, ref, rpr, test, urge, warn, whisper,
  ...
  if (module.parent == null) {
    include = ["(IDL) parse simple formulas", "(IDL) reject bogus formulas", "(IDLX) parse simple formulas"];
    this._prune();
    this._main();
  }
