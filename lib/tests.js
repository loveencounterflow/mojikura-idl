...
(function() {
  ...
  if (module.parent == null) {
    include = ["(IDL) parse simple formulas", "(IDL) reject bogus formulas", "(IDLX) parse simple formulas", "(IDLX) reject bogus formulas", "(IDLX) reject IDL operators with arity 3"];
    this._prune();
    this._main();
  }
