...
(function() {
  ...
  this["(IDLX) parse extended formulas"] = function(T) {
    var i, len, matcher, probe, probes_and_matchers, ref1, result;
  ...
  if (module.parent == null) {
    include = ["sanity checks (private methods)", "sanity checks (grammar data)", "(IDL) parse simple formulas", "(IDL) parse tree of simple formulas", "(IDL) reject bogus formulas", "(IDLX) parse simple formulas", "(IDLX) reject bogus formulas", "(IDLX) reject IDL operators with arity 3", "(IDLX) parse extended formulas"];
    this._prune();
    this._main();
  }
