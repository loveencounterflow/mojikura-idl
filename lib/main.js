...
(function() {
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.IDLX.list_tokens = (diagram_or_formula) => {
    var R, diagram, type;
    ...
    R = this.IDLX._list_tokens(diagram, []);
    return R;
  };

  //-----------------------------------------------------------------------------------------------------------
  this.IDLX._list_tokens = (diagram, R) => {
    ...
    for (idx = i = 0, len = diagram.length; i < len; idx = ++i) {
      ...
      switch (type = CND.type_of(element)) {
        ...
        case 'list':
          ...
          R.splice(R.length, 0, ...(this.IDLX.list_tokens(element, R)));
          break;
        default:
