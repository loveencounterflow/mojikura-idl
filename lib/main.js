...
(function() {
  'use strict';
  var CND, IDLX_GRAMMAR, IDL_GRAMMAR, Idl_lexer, NCR, NEARLEY, PATH, badge, debug, diagram, echo, formula, help, info, log, rpr, tokens, urge, warn, whisper, σ_mojikura,
    slice = [].slice;
  ...
  this.IDLX.type_from_literal = (function(_this) {
    return function(literal) {
      var ref;
      return (ref = IDLX_GRAMMAR[σ_mojikura].literals_and_types[literal]) != null ? ref : 'component';
    };
  })(this);
