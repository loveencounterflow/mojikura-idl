...
(function() {
  ...
  this.IDLX._get_literals_and_types = (function(_this) {
    return function(grammar) {
      var paths;
      paths = _this.IDLX._paths_from_grammar(grammar);
  ...
  this.IDLX._text_with_jzr_glyphs_as_uchrs = (function(_this) {
  ...
  this.IDLX._text_with_jzr_glyphs_as_xncrs = (function(_this) {
    return function(text) {
      var glyph;
      return ((function() {
        var i, len, ref, results;
  ...
  this.IDLX.formula_may_be_nonminimal = (function(_this) {
  ...
  this.IDLX.minimize_diagram = (function(_this) {
  ...
  this.IDLX.minimize_formula = (function(_this) {
    return function(formula) {
      var type;
      if ((type = CND.type_of(formula)) !== 'text') {
